...
if __name__ == '__main__':
    ...
    plt.plot(x, train_accuracy_1, label='resnet50')
    # plt.plot(x, train_accuracy_2, label='resnet50+da')
    # plt.plot(x, train_accuracy_3, label='resnext50+da')
    # plt.plot(x, train_accuracy_4, label='resnext50+da+pre')
    plt.xlabel('epoch')
    plt.ylabel('accuracy')
    ...
    plt.savefig('./figure/train_accuracy.png')
    plt.show()